            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-slate-50/50">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-bold text-gray-800 uppercase tracking-tight text-sm">Real-time Order Feed</h3>
                    </div>
                ...
                <div className="divide-y divide-gray-50">
                    {orders.length === 0 && !loading && (
                        <div className="p-12 text-center">
                            <Wine className="w-12 h-12 text-gray-200 mx-auto mb-4" />
                        ...
                        <div key={order.id} className="p-5 flex justify-between items-center hover:bg-slate-50 transition-colors group">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="font-bold text-gray-900">
                                        {order.metadata?.table_number ? `Table ${order.metadata.table_number}` : order.customer_name || 'Guest'}
                                    </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <button
                                    ...
                                    className="p-2 bg-slate-100 rounded-xl text-slate-400 hover:bg-emerald-600 hover:text-white transition-all shadow-sm"
                                >
