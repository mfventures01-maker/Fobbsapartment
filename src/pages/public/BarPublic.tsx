    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6">
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between space-y-4 sm:space-y-0 mb-6 pb-4 border-b border-gray-200">
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                            <h1 className="text-3xl font-bold text-gray-900 font-serif">Fobbs Menu</h1>
                            {(room || tableNumber) && (
                    ...
                    <div className="flex bg-gray-200 p-1 rounded-xl shrink-0">
                        <button
                            ...
                            className={`px-5 py-2 rounded-lg font-bold text-sm transition-all shadow-sm ${activeTab === 'bar' ? 'bg-white text-emerald-700' : 'text-gray-500 shadow-none'}`}
                        >
                            🍸 Bar & Drinks
                        </button>
                        <button
                            onClick={() => setActiveTab('food')}
                            className={`px-5 py-2 rounded-lg font-bold text-sm transition-all shadow-sm ${activeTab === 'food' ? 'bg-white text-emerald-700' : 'text-gray-500 shadow-none'}`}
                        >
                            🍽️ Restaurant Food
                        </button>
                    </div>
                ...
                {activeTab === 'food' ? (
                    <Suspense fallback={<div className="p-8 text-center animate-pulse"><Loader2 className="w-6 h-6 animate-spin mx-auto text-emerald-600 mb-2" />Loading menu engine...</div>}>
                        <RestaurantMenu />
                    </Suspense>
                ) : (
