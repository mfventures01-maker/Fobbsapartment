-- CARSS PHASE 3: GLOBAL VS BRANCH SSOT REFINEMENT
-- TARGET: Allow CEOs global view while enforcing strict branch-lock for Staff/Managers.
-- TARGET: Add branch_performance back to system state.
...
BEGIN
    ...
    -- C. SCOPED ACTIVE SHIFT (Local to this Branch if provided, else staff's own)
